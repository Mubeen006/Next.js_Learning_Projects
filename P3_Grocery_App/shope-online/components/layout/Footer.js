    ...
    <footer className="bg-gray-800 text-white mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Shope Online</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shopping-lists" className="text-gray-400 hover:text-white">
                  Shopping Lists
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <LocationMarkerIcon className="h-6 w-6 text-gray-400 mr-2" />
                <span className="text-gray-400">
                  123 Grocery Street,<br />
                  Market Square, CA 90210
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@shopeonline.com" className="text-gray-400 hover:text-white">
                  info@shopeonline.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Shope Online. All rights reserved.
          </p>
